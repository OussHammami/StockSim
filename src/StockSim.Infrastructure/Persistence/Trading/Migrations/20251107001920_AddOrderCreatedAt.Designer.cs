...
namespace StockSim.Infrastructure.Persistence.Trading.Migrations
{
    ...
    [Migration("20251107001920_AddOrderCreatedAt")]
            ...
            modelBuilder.Entity("StockSim.Infrastructure.Inbox.InboxMessage", b =>
                {
                    ...
                    b.ToTable("inbox_messages", "trading");
                });
            ...
            modelBuilder.Entity("StockSim.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_messages", "trading");
                });
