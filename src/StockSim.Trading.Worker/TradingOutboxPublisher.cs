                    ...
                    try
                    {
                        ...
                        try
                        {
                            using var activity = parentContext.ActivityContext.TraceId != default
                                ? Telemetry.OrdersSource.StartActivity("rabbitmq.publish", ActivityKind.Producer, parentContext.ActivityContext)
                                : Telemetry.OrdersSource.StartActivity("rabbitmq.publish", ActivityKind.Producer);
